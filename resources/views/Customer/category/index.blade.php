					...
					<div class="product product-single">
                        ...
                        @if($related->discount_perc >0 )
							...
							<div class="social-buttons" style="display:inline-block">
                                ...
                                <button class="main-btn icon-btn" style="color: #000;"><i class="fa fa-heart text-success"></i></button>
...
$.ajax({
	...
	url: "category/fetch_productWhere",
		data:
	{
		_token:token,
...
$.ajax({
	...
	url: "category/fetch_productBrands",
		data:
	{
		_token:token,
		selection:$('#selectSort option:selected').val(),
...
$.ajax({
	...
	url: "category/fetch_productGenders",
		data:
	{
		_token:token,
		selection:$('#selectSort option:selected').val(),
...
$.ajax({
	...
	url: "category/fetch_productOffers",
		data:
	{
		_token:token,
		selection:$('#selectSort option:selected').val(),
...
$.ajax({
	...
	url: "category/fetch_productPrice",
		data:
	{
		_token:token,
		selection:$('#selectSort option:selected').val(),
...
$.ajax({
	...
	url: "category/fetch_productShop",
		data:
	{
		_token:token,
		selection:$('#selectSort option:selected').val(),
...
function fetch_productdata(page,token,billToBrand,billToEmail,billToGender,billToOffer,billToShop)
 {
	...
	$.ajax({
    type: 'post',
    url:"category/fetch_productPrice?page="+page,
    data:
    {
		_token:token,
		selection:$('#selectSort option:selected').val(),
