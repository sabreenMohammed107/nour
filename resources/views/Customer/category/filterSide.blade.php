                ...
                <form id="categoryTarget" action="javascript:void(0)" method="post">
                    ...
                    @foreach($subs as $sub )
						...
						<ul class="list-links">
                            ...
                            <input type="checkbox"  name="subId" value="{{$subSub->id}}"   checked /><span>{{$subSub->en_name}}</span><br>
                            @else
                            <input type="checkbox"  name="subId" value="{{$subSub->id}}"  /><span>{{$subSub->en_name}}</span><br>
