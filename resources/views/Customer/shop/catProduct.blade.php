...
<div class="store-filter clearfix">
					...
					<!-- STORE -->
					<div id="store">
					<div class="alert alert-success" id="addCart" role="alert" style="display:none;" >The Product has been added to Your Cart</div>
<div class="alert alert-danger" id="delCart" role="alert" style="display:none;" >The Product Not add in your cart</div>
