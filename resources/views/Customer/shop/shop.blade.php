...
//function of pagination product
 ...
 function fetch_productdata(page,token,billToBrand,billToEmail,billToGender,billToOffer)
 {
  ...
  $.ajax({
    type: 'post',
    url:"shop/fetch_productPrice?page="+page,
    data:
    {
		selection:$('#selectSort option:selected').val(),
		_token:token,
...
function addProductCart(id){
   ...
   success:function(data)
   {
	...
	$("#addCart").fadeTo(2000, 500).slideUp(500, function() {
      $("#addCart").slideUp(3000);
    });
   } ,
   error: function(response){
	$("#delCart").fadeTo(2000, 500).slideUp(500, function() {
      $("#delCart").slideUp(3000);
	});
    }
  });
}
