                            ...
                            <strong name="price"  class="primary-color">{{ $details->products->price * $details->product_qty }}</strong>
								...
								<tfoot>
									<tr>
										...
										<th>SUBTOTAL</th>
										<th colspan="2" class="sub-total">{{$cart->total_cost}}</th>
									</tr>
									<tr>
										<th class="empty" colspan="3"></th>
										<th>SHIPING</th>
										<td colspan="2" class="sub-total">{{$cart->shipping_value}}</td>
									</tr>
									<tr>
										<th class="empty" colspan="3"></th>
										<th>TOTAL</th>
										<th colspan="2" class="total">{{$cart->net_value}}</th>
									</tr>
								</tfoot>
							</table>
							<div class="pull-right">
								<button class="primary-btn">Confirm Order</button>
							</div>
						</div>
